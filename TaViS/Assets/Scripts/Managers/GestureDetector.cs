...
public class GestureDetector : IDisposable
{
    ...
    private readonly string drinkGesture = "Drink";
        ...
        using (VisualGestureBuilderFrame frame = frameReference.AcquireFrame())
        {
            if (frame != null)
            {
                ...
                if (discreteResults != null)
                {
                    ...
                    {
                        string name = FindGestureName(gesture.Name);
                        ...
                        { 
                            ...
                            if (result != null)
                            {
                                ...
                                {
                                    if (result.Detected && result.Confidence > 0.0f)
                                    {
                                        Debug.Log(name + " from GestureDetector");
    ...
    private string FindGestureName(string gesture)
    {
        if (gesture.Equals(tipHatGesture))
            return tipHatGesture;
        else if (gesture.Equals(drinkGesture))
            return drinkGesture;
        else
            return "";
    }
